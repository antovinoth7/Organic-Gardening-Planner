...
[buildProfileKey("vegetable", "Brinjal")]: {
    ...
    description: "Versatile tropical nightshade yielding glossy purple fruit for curries and grills",
...
[buildProfileKey("vegetable", "Cucumber")]: {
    ...
    description: "Fast-growing warm-season vine producing crisp, refreshing fruits. Thrives in Kanyakumari's tropical heat with consistent moisture and trellis support.",
  ...
  [buildProfileKey("vegetable", "Spinach")]: {
    ...
    description: "Nutrient-dense leafy green rich in iron and vitamins. Prefers cooler periods but grows year-round in partial shade in Kanyakumari's coastal climate.",
  ...
  [buildProfileKey("vegetable", "Radish")]: {
    ...
    lifecycle: "annual",
    tamilName: "முள்ளங்கி",
    description: "One of the fastest-maturing root vegetables. Excellent beginner crop for Kanyakumari gardens, thriving in the cool dry season with loose, well-drained soil.",
    daysToHarvest: { min: 25, max: 35 },
    heightCm: { min: 15, max: 30 },
    spacingCm: 8,
    plantingDepthCm: 1,
  ...
  [buildProfileKey("vegetable", "Onion")]: {
    ...
    lifecycle: "biennial",
    tamilName: "வெங்காயம்",
    description: "Essential kitchen staple grown as a bulb crop. Requires well-drained soil and full sun during the cool dry season in Kanyakumari for proper bulb development.",
  ...
  [buildProfileKey("vegetable", "Shallot")]: {
    ...
    description: "Small, pungent bulb onion widely used in South Indian cooking. Multiplies readily from sets and adapts well to Kanyakumari's coastal conditions.",
  ...
  [buildProfileKey("vegetable", "Garlic")]: {
    ...
    lifecycle: "perennial",
    tamilName: "பூண்டு",
    description: "Pungent bulb with potent medicinal and culinary value. Requires well-drained soil and the cool dry season of Kanyakumari for bulb formation.",
  ...
  [buildProfileKey("vegetable", "Cabbage")]: {
    ...
    description: "Cool-season brassica forming dense leafy heads. Requires consistent moisture and fertile soil during Kanyakumari's cool dry months for tight head formation.",
    daysToHarvest: { min: 80, max: 100 },
  ...
  [buildProfileKey("vegetable", "Cauliflower")]: {
    ...
    description: "Cool-season brassica producing compact white curds. Demands rich soil, consistent watering, and the cooler months in Kanyakumari for quality head development.",
  ...
  [buildProfileKey("vegetable", "Carrot")]: {
    ...
    lifecycle: "biennial",
    tamilName: "கேரட்",
    description: "Popular root vegetable rich in beta-carotene. Needs deep, loose, stone-free soil for straight root growth during Kanyakumari's cool dry season.",
    daysToHarvest: { min: 70, max: 90 },
  ...
  [buildProfileKey("vegetable", "Potato")]: {
    ...
    description: "Versatile tuberous crop grown worldwide. Requires loose, well-drained soil and hilling during the cool dry season in Kanyakumari for tuber development.",
    daysToHarvest: { min: 80, max: 100 },
  ...
  [buildProfileKey("vegetable", "Eggplant")]: {
    ...
    description: "Heat-loving fruiting vegetable closely related to brinjal. Produces prolifically year-round in Kanyakumari's warm climate with regular feeding and pruning.",
    daysToHarvest: { min: 60, max: 80 },
    heightCm: { min: 45, max: 120 },
    spacingCm: 60,
    plantingDepthCm: 1,
  ...
  [buildProfileKey("vegetable", "Pepper")]: {
    ...
    description: "Warm-season fruiting plant related to chilli, producing sweet or mildly hot fruits. Grows year-round in Kanyakumari with good drainage and regular feeding.",
    daysToHarvest: { min: 60, max: 90 },
  ...
  [buildProfileKey("vegetable", "Taro")]: {
    ...
    description: "Tropical tuber crop with edible corms and leaves. Thrives in Kanyakumari's monsoon moisture with partial shade and consistently wet, humus-rich soil.",
  ...
  [buildProfileKey("vegetable", "Elephant Yam")]: {
    ...
    description: "Large tropical tuber crop valued in South Indian cuisine. Requires minimal maintenance once established, thriving in Kanyakumari's monsoon season with rich organic soil.",
  ...
  [buildProfileKey("vegetable", "Sweet Potato")]: {
    ...
    description: "Nutritious tropical vine producing sweet tuberous roots. Well-suited to Kanyakumari's warm monsoon season, spreading as ground cover in sandy or loamy soils.",
    daysToHarvest: { min: 100, max: 140 },
    heightCm: { min: 20, max: 40 },
    spacingCm: 30,
    plantingDepthCm: 8,
  ...
  [buildProfileKey("vegetable", "Ash Plantain")]: {
    ...
    description: "Starchy cooking banana widely used in South Indian cuisine. A robust perennial producing suckers freely in Kanyakumari's humid monsoon climate with rich, moist soil.",
  ...
  [buildProfileKey("vegetable", "Colocasia")]: {
    ...
    lifecycle: "perennial",
    tamilName: "சேம்பு",
    description: "Versatile aroid grown for both corms and leaves (colocasia leaves used in South Indian dishes). Flourishes in Kanyakumari's monsoon wet season with boggy, humus-rich conditions.",
    daysToHarvest: { min: 180, max: 270 },
    heightCm: { min: 60, max: 150 },
    spacingCm: 45,
    plantingDepthCm: 8,
