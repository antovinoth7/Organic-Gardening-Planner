...
const PLANT_CARE_OVERRIDES: Record<string, PlantCareProfile> = {
  ...
  [buildProfileKey("vegetable", "Tomato (Thakkali)")]: {
    waterRequirement: "high",
    wateringFrequencyDays: 2,
    fertilisingFrequencyDays: 14,
    pruningFrequencyDays: 21,
  ...
  [buildProfileKey("vegetable", "Brinjal (Kathirikai)")]: {
    waterRequirement: "medium",
    wateringFrequencyDays: 2,
    fertilisingFrequencyDays: 14,
    pruningFrequencyDays: 30,
  ...
  [buildProfileKey("vegetable", "Bhendi / Okra (Vendakkai)")]: {
    waterRequirement: "medium",
    wateringFrequencyDays: 2,
    fertilisingFrequencyDays: 14,
    pruningFrequencyDays: 30,
  ...
  [buildProfileKey("vegetable", "Drumstick (Murungakkai)")]: {
    waterRequirement: "medium",
  ...
  [buildProfileKey("herb", "Holy Basil (Thulasi)")]: {
    waterRequirement: "medium",
    wateringFrequencyDays: 2,
    fertilisingFrequencyDays: 21,
    pruningFrequencyDays: 21,
  ...
  [buildProfileKey("fruit_tree", "Mango (Ma)")]: {
    waterRequirement: "medium",
    wateringFrequencyDays: 7,
    fertilisingFrequencyDays: 60,
    pruningFrequencyDays: 180,
  ...
  [buildProfileKey("fruit_tree", "Banana (Vazhai)")]: {
    waterRequirement: "high",
    wateringFrequencyDays: 2,
    fertilisingFrequencyDays: 30,
    pruningFrequencyDays: 90,
  ...
  [buildProfileKey("fruit_tree", "Guava (Koyya)")]: {
    waterRequirement: "medium",
    wateringFrequencyDays: 5,
    fertilisingFrequencyDays: 45,
    pruningFrequencyDays: 180,
